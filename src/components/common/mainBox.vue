...
-->
  <!--view-box-->
  <div class="mainBoxCom" ref="mainBoxCom"
            :style="`height: calc(100% - ${top} - ${bottom})`">
    <slot></slot>
    <div id="noMoreBox" v-if="noData">
      <span class="text">暂无数据</span>
    </div>
    <div v-show="toHome" class="toHome" id="toHome"
         @click.stop="toHomeClick">
      <slot name="toHome">
